...
def main():
    ...
    base = AutoModelForCausalLM.from_pretrained(
        ...
        quantization_config=bnb, dtype=torch.bfloat16,  # 修改为 dtype
        local_files_only=True  # 强制使用本地缓存文件
    )
    ...
    # 设置训练配置，移除 evaluation_strategy 和 dataset_text_field
    conf = SFTConfig(
        output_dir=out_dir,
        max_length=2048,
        packing=False,
